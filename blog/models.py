...
class Blog(models.Model):
    ...
    date_posted = models.DateTimeField(
        auto_now_add=True, help_text=_("Enter the date the blog was posted")
    )
    # retaled name is the name of the reverse relation
...
class Blogger(models.Model):
    bio = models.TextField(help_text=_("Enter the bio of the blogger"), blank=True)
...
class Comment(models.Model):
    content = models.TextField(help_text=_("Enter the content of the comment"))
    ...
    date_posted = models.DateTimeField(
        auto_now_add=True, help_text=_("Enter the date the comment was posted")
    )
